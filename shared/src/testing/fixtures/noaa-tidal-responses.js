...
exports.MOCK_STATION_INFO_BOSTON = exports.MOCK_TIDAL_ERROR_INVALID_DATE = exports.MOCK_TIDAL_ERROR_INVALID_STATION = exports.MOCK_CURRENT_PREDICTIONS_DANGEROUS = exports.MOCK_CURRENT_PREDICTIONS_BOSTON = exports.MOCK_TIDAL_PREDICTIONS_NEAP = exports.MOCK_TIDAL_PREDICTIONS_SPRING = exports.MOCK_TIDAL_PREDICTIONS_BOSTON = exports.MOCK_STATIONS_BOSTON_AREA = void 0;
exports.createMockTidalPrediction = createMockTidalPrediction;
exports.createMockCurrentPrediction = createMockCurrentPrediction;
exports.generateDailyTidalCycle = generateDailyTidalCycle;
/**
 * NOAA Tidal Station List Response
 * From: api.tidesandcurrents.noaa.gov/mdapi/prod/webapi/stations.json
 */
exports.MOCK_STATIONS_BOSTON_AREA = {
    stations: [
        {
            id: '8443970',
            name: 'Boston, MA',
 ...
 */
exports.MOCK_TIDAL_PREDICTIONS_SPRING = {
    predictions: [
        {
            t: '2024-01-20 06:00',
            v: '12.5', // High
 ...
 */
exports.MOCK_TIDAL_PREDICTIONS_NEAP = {
    predictions: [
        {
            t: '2024-01-20 06:00',
            v: '7.2', // High
 ...
 */
exports.MOCK_CURRENT_PREDICTIONS_BOSTON = {
    current_predictions: [
        {
            t: '2024-01-20 06:00',
 ...
 */
exports.MOCK_CURRENT_PREDICTIONS_DANGEROUS = {
    current_predictions: [
        {
            t: '2024-01-20 12:00',
 ...
 */
exports.MOCK_TIDAL_ERROR_INVALID_STATION = {
    error: {
 ...
 */
function createMockTidalPrediction(time, height, type) {
    return {
 ...
 */
function createMockCurrentPrediction(time, velocity, direction, type) {
    return {
        t: time.toISOString().slice(0, 16).replace('T', ' '),
        v: velocity.toString(),
 ...
 */
function generateDailyTidalCycle(startDate, highTide, lowTide) {
    const predictions = [];
    const baseTime = startDate.getTime();
    // High tide at 6:00
    predictions.push(createMockTidalPrediction(new Date(baseTime), highTide, 'H'));
    // Low tide at 12:30 (6.5 hours later)
    predictions.push(createMockTidalPrediction(new Date(baseTime + 6.5 * 60 * 60 * 1000), lowTide, 'L'));
    // High tide at 18:24 (12.4 hours later)
    predictions.push(createMockTidalPrediction(new Date(baseTime + 12.4 * 60 * 60 * 1000), highTide, 'H'));
    // Low tide at 00:48 next day (18.8 hours later)
    predictions.push(createMockTidalPrediction(new Date(baseTime + 18.8 * 60 * 60 * 1000), lowTide, 'L'));
    return { predictions };
}
//# sourceMappingURL=noaa-tidal-responses.js.map