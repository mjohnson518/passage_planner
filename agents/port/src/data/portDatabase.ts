/**
 * Port and Marina Database — global coverage.
 *
 * The bulk of entries below are US (East Coast, Gulf, West Coast, Great
 * Lakes) and Mediterranean, seeded historically. Non-Mediterranean global
 * coverage (Caribbean, UK/Ireland, Northern Europe, Australia/NZ, Pacific
 * Islands, SE Asia, South Africa, Canada) lives in `./globalPorts.ts` and
 * is spread into `PORT_DATABASE` below so all helpers (`getPortById`,
 * `findNearestPorts`) operate on a single combined list.
 *
 * Data includes: marinas, anchorages, harbors with services, navigation
 * info, and local knowledge. Mariners must cross-check facilities with
 * the harbour master before relying — local conditions change yearly.
 */

import { GLOBAL_PORTS } from "./globalPorts";
...
export const PORT_DATABASE: Port[] = [
  {
    ...
    type: "marina",
    coordinates: { latitude: 42.3736, longitude: -71.052 },
    ...
    navigation: {
      ...
      bestTideState:
        "Enter/exit 2 hours either side of high tide for maximum depth",
    },
    services: {
      slips: {
        available: true,
    ...
    localKnowledge: {
      bestApproach:
        "Monitor Boston VTS on VHF 14. Follow Traffic Separation Scheme",
      weatherConsiderations: [
        "Fog common in spring/summer",
        "Strong winds funnel through harbor in winter",
      ],
...

  {
    ...
    facilities: {
      fuel: {
        diesel: true,
        gasoline: true,
        hours: "0700-1900 summer, 0800-1700 winter",
      },
      water: true,
      electricity: true,
      pumpout: true,
      ...
      repair: {
        available: true,
        types: ["engine", "rigging", "electronics", "canvas"],
      },
      haulOut: true,
      chandlery: true,
    },
    ...
    services: {
      slips: {
        ...
        transient: true,
        maxLength: 200,
        reservation: "Required summer weekends",
      },
    ...
    localKnowledge: {
      bestApproach:
        "Monitor Portland Harbor on VHF 13. Follow buoyed channel carefully",
      weatherConsiderations: [
        "Fog very common May-September",
        "Strong SW winds in winter",
      ],
      tidalConsiderations:
        "Current runs 2-3 knots at harbor entrance - plan arrival/departure at slack",
      notes: [
...

  {
    ...
    services: {
      ...
      anchorage: {
        available: true,
        holding: "Good - mud/sand",
        depth: "12-20 ft",
        protection: ["N", "NE", "E", "SE"],
      },
    },
    contact: {
      vhf: "9, 71",
    ...
    localKnowledge: {
      bestApproach:
        "East Passage is deeper and preferred. Avoid race courses on summer weekends",
      weatherConsiderations: [
        "SW winds dominate summer",
        "Thunderstorms July-August",
      ],
      tidalConsiderations:
        "Moderate tidal current in passages - plan for slack or favorable",
      notes: [
...

  {
    ...
    navigation: {
      ...
      bestTideState:
        "Monitor depths at river entrance - favor high tide if draft >6ft",
    },
    services: {
      slips: {
        available: true,
    ...
    localKnowledge: {
      ...
      weatherConsiderations: [
        ...
        "Strong NW winds in winter",
      ],
      tidalConsiderations:
        "Minimal tidal influence - current rarely exceeds 0.5 knots",
      notes: [
...

  {
    ...
    facilities: {
      ...
      repair: {
        available: true,
        types: ["engine", "rigging", "electronics", "fiberglass"],
      },
      haulOut: true,
      chandlery: true,
    },
    ...
    localKnowledge: {
      bestApproach:
        "Monitor Charleston Traffic on VHF 11/13. Stay clear of shipping channel when possible",
      weatherConsiderations: [
        "Afternoon thunderstorms April-September",
        "Hurricane season June-November",
      ],
      tidalConsiderations:
        "Current runs 2-3 knots in main channel - plan arrival for slack or favorable",
      notes: [
...

  {
    ...
    facilities: {
      ...
      repair: {
        available: true,
        types: ["engine", "rigging", "electronics", "woodwork"],
      },
      haulOut: true,
      chandlery: true,
    },
    navigation: {
      ...
      tidalRange: 10.5,
      approach:
        "From south via Muscle Ridge Channel or from east via Two Bush Channel",
      hazards: [
        "Numerous ledges and rocks",
    ...
    localKnowledge: {
      bestApproach:
        "Muscle Ridge Channel is well-marked. Use chart carefully - many ledges",
      weatherConsiderations: [
        "Fog very common June-August",
        "Strong NE winds in fall/spring",
      ],
...

  {
    ...
    services: {
      ...
      anchorage: {
        available: true,
        holding: "Fair - sand/mud",
        depth: "8-12 ft",
        protection: ["All directions"],
      },
    },
    contact: {
      vhf: "9",
    ...
    localKnowledge: {
      bestApproach:
        "Line up range markers carefully. Channel is narrow - no room for error",
      weatherConsiderations: [
        "Exposed to ocean swells",
        "Afternoon SW breeze strong in summer",
      ],
      tidalConsiderations:
        "Current sets across entrance - approach on flood preferred",
      notes: [
...

  {
    ...
    navigation: {
      ...
      tidalRange: 3.0,
      approach:
        "Via Nantucket Sound - shifting channel requires local knowledge",
      hazards: [
        "Shifting sand bars",
        "Channel moves - use current charts",
        "Strong tidal current",
      ],
      bestTideState:
        "Draft >6ft should enter at half-tide rising or high water",
    },
    services: {
      slips: {
        available: true,
    ...
    localKnowledge: {
      bestApproach:
        "Harbor entrance shifts - get local knowledge or hire pilot. Monitor depths carefully",
      weatherConsiderations: [
        "Fog very common",
        "Exposed to ocean weather from S/SE",
      ],
      tidalConsiderations:
        "Strong cross-current in entrance - approach on flood preferred",
      notes: [
...

  {
    ...
    navigation: {
      ...
      hazards: [
        "Highway drawbridge (clearance 15ft closed)",
        "Railroad bridge (opens on request)",
      ],
    ...
    localKnowledge: {
      bestApproach:
        "Call drawbridge on VHF 13 for opening. Museum worth visiting",
      weatherConsiderations: [
        "Well protected from weather",
        "Strong currents under bridges",
      ],
      notes: [
...

  {
    ...
    localKnowledge: {
      ...
      weatherConsiderations: [
        "Strong winds funnel through harbor",
        "Ice in winter",
      ],
...

  {
    ...
    type: "harbor",
    coordinates: { latitude: 38.9351, longitude: -74.906 },
    ...
    localKnowledge: {
      bestApproach:
        "Cape May Canal avoids ocean passage around cape in rough weather",
      weatherConsiderations: [
        "Can be rough at inlet in strong winds",
        "Fog in spring",
      ],
      tidalConsiderations:
        "Strong current at inlet - enter on flood for easier passage",
      notes: [
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Stay clear of military vessels - they have right of way. Monitor security zones",
      weatherConsiderations: [
        "Protected location",
        "Can be hot/humid in summer",
      ],
  ...
  // Additional US East Coast Ports (9-20)
  {
    ...
    localKnowledge: {
      bestApproach:
        "Classic cruising destination. Use local charts - many rocks",
      weatherConsiderations: [
        "Exposed to S/SW winds",
        "Excellent holding in normal weather",
      ],
      notes: [
        "Beautiful anchorage",
        "Limited services",
...

  {
    ...
    localKnowledge: {
      ...
      notes: [
        "Beautiful Maine harbor",
        "Excellent town",
        "Windjammer fleet based here",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Historic sailing town. Avoid race courses on summer weekends",
      weatherConsiderations: ["Well protected", "Can be rolly in NE winds"],
      notes: [
        "Prestigious yacht clubs",
        "Historic town",
        "Limited transient space",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: true,
      procedures: "Contact CBP for clearance",
    },
    localKnowledge: {
      bestApproach: "Historic maritime city. Well-marked approaches",
      weatherConsiderations: [
        "Good protection",
        "Strong NE winds can make harbor uncomfortable",
      ],
      notes: [
        "Historic waterfront",
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Monitor depths crossing entrance bar. Very popular destination",
      weatherConsiderations: [
        "Can be uncomfortable in S/SW winds",
        "Fog common",
      ],
      notes: [
        "Upscale Martha's Vineyard town",
        "Very busy summer",
        "Beautiful harbor",
      ],
    },
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Long Point at tip of Cape Cod. Sheltered from most weather",
      weatherConsiderations: [
        "Exposed to strong N winds",
        "Excellent in summer",
      ],
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Historic waterfront. Monitor inlet depths - channel can shift after storms",
      weatherConsiderations: [
        "Good protection",
        "Hurricane season June-November",
      ],
...

  {
    ...
    localKnowledge: {
      ...
      weatherConsiderations: [
        "Protected location",
        "Hurricane preparations important",
      ],
      notes: [
        "Historic downtown",
        "Excellent facilities",
        "Full-service yards nearby",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Monitor depths crossing Winyah Bay bar. Historic riverport",
...

  {
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: true,
      procedures: "First US port from Bahamas - CBP clearance required",
    },
    localKnowledge: {
      bestApproach:
        "Popular first stop returning from Bahamas. Historic downtown",
      weatherConsiderations: [
...

  {
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: true,
      procedures: "Contact CBP for clearance from foreign ports",
    },
    localKnowledge: {
      bestApproach:
        "Oldest city in USA. Inlet requires local knowledge or calm conditions",
      weatherConsiderations: [
        "Inlet dangerous in strong E/SE winds",
        "Protected inside",
      ],
      notes: [
        "Historic attractions",
        "Popular ICW stop",
        "Excellent downtown marina",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Charming NC coastal town. Watch for shipping traffic to Wilmington",
      weatherConsiderations: [
        "Good protection",
...

  {
    ...
    type: "marina",
    coordinates: { latitude: 25.732, longitude: -80.2321 },
    ...
    customs: {
      ...
      cbpRequired: true,
      hours: "24/7",
      procedures: "Major international port - full CBP services",
    },
    localKnowledge: {
      bestApproach:
        "Major metro marina. Heavy weekend traffic - arrive early for slip",
      weatherConsiderations: [
        "Protected from ocean",
        "Hurricane season June-November",
      ],
      notes: [
        "Large municipal marina",
        "Full services",
        "Easy city access",
        "Popular megayacht stop",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    customs: {
      ...
      cbpRequired: true,
      hours: "By appointment",
      procedures: "Required for vessels arriving from foreign ports",
    },
    localKnowledge: {
      bestApproach:
        "Use charts carefully - coral and shallow water. Monitor depths",
      weatherConsiderations: [
        "Tropical climate",
...

  {
    ...
    customs: {
      ...
      cbpRequired: true,
      hours: "24/7",
      procedures: "Major international yachting center",
    },
    localKnowledge: {
      bestApproach:
        "Yachting capital of the world. Count bridge clearances before entering",
      weatherConsiderations: [
        "Protected river location",
        "Hurricane preparations critical",
      ],
      notes: [
        "Major refit center",
...

  {
    ...
    type: "marina",
    coordinates: { latitude: 39.3797, longitude: -74.431 },
    ...
    localKnowledge: {
      bestApproach:
        "Casino marina. Monitor inlet conditions - can be dangerous in onshore winds",
      weatherConsiderations: [
        "Inlet rough in strong E/SE winds",
        "Protected inside",
      ],
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Beautiful small harbor. Line up range markers for narrow entrance",
      weatherConsiderations: [
        "Excellent protection once inside",
        "Hurricane hole",
      ],
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Classic Connecticut River town. Well protected from weather",
      weatherConsiderations: [
        "River provides excellent protection",
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "North Fork Long Island. Working shipyard with full services",
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Exclusive summer community. Shallow - shoal draft boats only",
...

  {
    ...
    type: "marina",
    coordinates: { latitude: 41.3315, longitude: -71.907 },
...

  {
    ...
    facilities: {
      ...
      repair: {
        available: true,
        types: ["engine", "fiberglass", "electronics"],
      },
      haulOut: false,
      chandlery: true,
    },
    navigation: {
      ...
      tidalRange: 1.5,
      approach:
        "Enter Pensacola Pass, follow marked channel to downtown waterfront",
      hazards: [
        "Strong currents at pass entrance",
        "Shallow areas outside channel",
      ],
      bestTideState: "Accessible all tides",
    },
    services: {
      slips: {
        ...
        transient: true,
        maxLength: 130,
        reservation: "Recommended in winter",
      },
      moorings: { available: false, rental: false },
      anchorage: {
        available: true,
    ...
    localKnowledge: {
      bestApproach:
        "Pensacola Pass has strong currents - time entry for slack water",
      weatherConsiderations: [
...

  {
    ...
    navigation: {
      ...
      hazards: [
        "Shallow approach in Sound",
        "Barrier islands reduce wave action",
      ],
    },
    services: {
...

  {
    ...
    navigation: {
      ...
      hazards: [
        "Strong Mississippi River current",
        "Commercial traffic in IHNC",
      ],
    },
    services: {
      slips: {
        ...
        transient: true,
        maxLength: 100,
        reservation: "Recommended during festivals",
      },
      moorings: { available: false, rental: false },
      anchorage: {
        available: false,
    ...
    localKnowledge: {
      bestApproach:
        "Lake Pontchartrain approach avoids Mississippi River current. Call ahead for lock schedules.",
      weatherConsiderations: [
        "Hurricane season Jun-Nov",
        "Summer heat extreme",
      ...
      notes: [
        "French Quarter walkable",
        "Mardi Gras reservations essential",
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Monitor VHF 13 for ship traffic. Stay well clear of commercial vessels.",
      weatherConsiderations: [
        "Hurricane season Jun-Nov",
        "Fog in winter",
        "Strong southerly sea breeze",
      ],
      notes: [
        "Gateway to Texas coast",
        "Good provisioning",
...

  {
    ...
    facilities: {
      ...
      repair: {
        available: true,
        types: ["engine", "rigging", "electronics", "fiberglass", "sails"],
      },
      haulOut: true,
      chandlery: true,
    },
    ...
    customs: {
      ...
      cbpRequired: true,
      hours: "24/7",
      procedures: "CBP office at Shelter Island",
    },
    localKnowledge: {
      bestApproach:
        "Fair-weather port, well protected inside bay. First US port for Mexico returnees.",
      weatherConsiderations: [
        "Mild year-round",
        "Fog common mornings May-Sep",
        "Santa Ana winds Oct-Dec",
      ],
      notes: [
        "Major cruising hub",
        "Excellent yacht services",
        "Baja Ha-Ha staging area",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Gateway to Channel Islands National Park. Well-maintained harbor.",
      weatherConsiderations: [
        "NW winds predominant",
        "Santa Ana winds Oct-Feb",
        "Fog common",
      ],
      notes: [
        "Staging point for Channel Islands",
        "Good marine services",
        "Nice waterfront restaurants",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    navigation: {
      ...
      hazards: [
        "Extremely strong currents (3-5 knots) at Golden Gate",
        "Fog",
        "Heavy commercial traffic",
      ],
      bestTideState:
        "Time Golden Gate entry for slack water or favorable current",
    },
    services: {
      slips: {
        available: true,
    ...
    localKnowledge: {
      bestApproach:
        "Time Golden Gate passage for slack water. Max ebb current 5+ knots. Monitor VHF 14 for VTS.",
      weatherConsiderations: [
        "Fog very common May-Sep",
        "Strong afternoon westerlies 20-30kt",
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Protected from NW swell by breakwater. Monterey Bay National Marine Sanctuary rules apply.",
      weatherConsiderations: [
        "Fog common",
        "NW winds afternoon",
        "Can be exposed to southerly storms",
      ],
      notes: [
        "Cannery Row nearby",
...

  {
    ...
    localKnowledge: {
      bestApproach:
        "Largest marina in Pacific NW. Monitor VHF 5A for Puget Sound VTS.",
      weatherConsiderations: [
        "Rain common Oct-May",
        "Mild temperatures",
        "Wind funnels through Sound",
      ],
      notes: [
        "1400+ slips",
        "Excellent marine services",
        "Gateway to San Juan Islands",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    type: "marina",
    coordinates: { latitude: 48.534, longitude: -123.0168 },
    ...
    navigation: {
      ...
      hazards: [
        "Strong tidal currents in channel (3-4 knots)",
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: true,
      procedures: "Clear customs on arrival from Canada",
    },
    localKnowledge: {
      bestApproach:
        "Beautiful approach through San Juan Islands. Time for slack current in channels.",
      weatherConsiderations: [
        "Rain shadow - drier than Seattle",
        "Current is biggest factor",
        "Fog occasional",
      ],
      notes: [
        "Orca whale watching",
        "Charming town",
        "Customs clearance for Canada crossings",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    type: "harbor",
    coordinates: { latitude: 45.848, longitude: -84.6189 },
    ...
    localKnowledge: {
      bestApproach:
        "Iconic Great Lakes destination. No cars on island - bicycle or horse transport.",
      weatherConsiderations: [
        "Season May-Oct only",
        "Strong storms can develop quickly",
        "Ice Nov-Apr",
      ],
      notes: [
        "No motor vehicles",
        "Historic Grand Hotel",
        "Chicago-Mac race finish",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    navigation: {
      ...
      tidalRange: 0.0,
      approach:
        "From Lake Michigan, enter breakwater-protected harbor near Navy Pier",
      hazards: [
        "Large vessel traffic at harbor entrance",
        "Strong NE storms create large waves",
      ],
    },
    services: {
      slips: {
        ...
        transient: true,
        maxLength: 70,
        reservation: "Required in summer",
      },
      moorings: { available: false, rental: false },
      anchorage: {
        available: false,
    ...
    localKnowledge: {
      bestApproach:
        "Stunning Chicago skyline approach. Call ahead - fills quickly in summer.",
      weatherConsiderations: [
        "Season Apr-Nov",
        "Sudden storms on Lake Michigan",
        "Ice Dec-Mar",
      ],
      notes: [
        "Downtown Chicago location",
        "Museums and Magnificent Mile nearby",
        "Race to Mackinac staging",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    navigation: {
      ...
      hazards: [
        "Shallow areas around islands",
        "Heavy recreational traffic in summer",
      ],
    },
    services: {
    ...
    localKnowledge: {
      bestApproach:
        "Popular Lake Erie cruising destination. South Bass Island.",
      weatherConsiderations: [
        "Season May-Oct",
        "Lake Erie storms build quickly",
        "Shallow lake = steep waves",
      ],
      notes: [
        "Perry's Victory monument",
        "Party island atmosphere",
        "Good holding in harbor",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    navigation: {
      ...
      tidalRange: 3.0,
      approach:
        "Via Sea of Abaco from north or south, follow markers to harbour",
      hazards: [
        "Coral heads",
        "Shallow banks outside channel",
        "Strong tidal flow in cuts",
      ],
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: false,
      procedures: "Clear in at government dock with immigration and customs",
    },
    localKnowledge: {
      bestApproach:
        "Hub of the Abacos. Well-stocked for cruisers. Use updated charts - Hurricane Dorian changed depths.",
      weatherConsiderations: [
        "Hurricane season Jun-Nov",
        "Trade winds 10-20kt typical",
        "Cold fronts Dec-Mar",
      ],
      notes: [
        "Cruiser hub",
        "Good provisioning",
        "Recovering from Hurricane Dorian (2019)",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    type: "marina",
    coordinates: { latitude: 25.08, longitude: -77.34 },
    ...
    navigation: {
      ...
      hazards: [
        "Cruise ship traffic",
        "Strong current in harbour entrance",
    ...
    services: {
      slips: {
        ...
        transient: true,
        maxLength: 150,
        reservation: "Recommended in season",
      },
      moorings: { available: false, rental: false },
      anchorage: {
        available: true,
    ...
    customs: {
      ...
      cbpRequired: false,
      procedures:
        "Clear at main customs dock. Yellow Q flag required until cleared.",
    },
    localKnowledge: {
      bestApproach:
        "Time entrance to avoid cruise ship departures (usually 5-7pm). Fly Q flag until cleared.",
      weatherConsiderations: [
        "Hurricane season Jun-Nov",
        "Trade winds predominant",
        "Christmas Winds Dec-Jan",
      ],
      notes: [
        "Major Bahamas port of entry",
        "Good reprovisioning",
...

  {
    ...
    type: "anchorage",
    coordinates: { latitude: 23.516, longitude: -75.778 },
    ...
    navigation: {
      ...
      hazards: [
        "Coral heads in Elizabeth Harbour",
        "Strong current in channels",
      ],
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: false,
      procedures: "Clear at government dock in town",
    },
    localKnowledge: {
      bestApproach:
        "Elizabeth Harbour offers excellent all-weather protection. Cruiser community Feb-Apr.",
      weatherConsiderations: [
        "Hurricane season Jun-Nov",
        "Trade winds 15-25kt winter",
        "Regatta in Apr",
      ],
      notes: [
        "Famous cruiser gathering spot",
        "Georgetown Regatta April",
        "Limited but adequate provisioning",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    type: "marina",
    coordinates: { latitude: 50.3656, longitude: -4.131 },
    ...
    facilities: {
      ...
      repair: {
        available: true,
        types: ["engine", "rigging", "electronics", "sails"],
      },
      haulOut: true,
      chandlery: true,
    },
    navigation: {
      ...
      tidalRange: 15.0,
      approach:
        "Enter Plymouth Sound past the Breakwater, head east to Cattewater",
      hazards: [
        "Large tidal range",
        "Naval vessels in Sound",
        "Drake Channel traffic",
      ],
    ...
    services: {
      slips: {
        ...
        transient: true,
        maxLength: 120,
        reservation: "Recommended Jul-Aug",
      },
      moorings: { available: false, rental: false },
      anchorage: {
        available: true,
    ...
    contact: {
      ...
      website: "queeneannesbattery.co.uk",
    },
    customs: {
      portOfEntry: true,
      cbpRequired: false,
      procedures: "Report to Border Force on arrival from outside UK",
    },
    localKnowledge: {
      bestApproach:
        "Plymouth Breakwater provides excellent protection. Major departure point for Atlantic crossings.",
      weatherConsiderations: [
        "SW gales common in winter",
        "Fog in summer",
        "Large tidal range (4.7m springs)",
      ],
      tidalConsiderations: "Tidal streams run strongly at breakwater entrance",
      notes: [
        "RNLI base",
        "Mayflower Steps nearby",
        "Excellent provisioning",
        "ARC rally starting point",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    facilities: {
      ...
      repair: {
        available: true,
        types: ["engine", "rigging", "sails", "electronics"],
      },
      haulOut: false,
      chandlery: true,
    },
    navigation: {
      ...
      tidalRange: 12.0,
      approach:
        "Enter the Solent from east or west, approach Cowes from the north",
      hazards: [
        "Very strong tidal streams in the Solent",
        "Heavy racing traffic",
        "Red Funnel ferry traffic",
      ],
    ...
    services: {
      slips: {
        ...
        transient: true,
        maxLength: 80,
        reservation: "Essential during Cowes Week (Aug)",
      },
      moorings: { available: true, rental: true },
      anchorage: {
        available: true,
    ...
    localKnowledge: {
      bestApproach:
        "Sailing capital of the world. Cowes Week first week of August. Book months ahead.",
      weatherConsiderations: [
        "Solent funnels wind",
        "Tidal streams critical for planning",
        "Sheltered from SW",
      ],
...

  {
    ...
    facilities: {
      ...
      repair: {
        available: true,
        types: ["engine", "rigging", "fiberglass", "sails"],
      },
      haulOut: true,
      chandlery: true,
    },
    navigation: {
      ...
      hazards: [
        "Black Rock at harbour entrance",
        "Large tidal range",
        "Manacles reef to the south",
      ],
    },
    services: {
      slips: { available: true, transient: true, maxLength: 100 },
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: false,
      procedures: "First UK port for many transatlantic arrivals",
    },
    localKnowledge: {
      bestApproach:
        "Third deepest natural harbour in the world. Traditional first/last port for Atlantic crossings.",
      weatherConsiderations: [
        "Well protected harbour",
        "SW gales can be severe outside",
        "Fog occasional",
      ],
      tidalConsiderations:
        "Very large tidal range - check berth depth at low springs",
      notes: [
        "Traditional Atlantic landfall/departure",
...

  {
    ...
    type: "marina",
    coordinates: { latitude: 48.3905, longitude: -4.434 },
    ...
    navigation: {
      ...
      hazards: [
        "Extremely strong tidal streams in Goulet (5+ knots)",
        "Naval base - restricted zones",
        "Large tidal range (7m springs)",
      ],
      bestTideState:
        "Time Goulet passage for slack water - life-safety critical",
    },
    services: {
      slips: {
        available: true,
    ...
    customs: {
      ...
      cbpRequired: false,
      procedures:
        "EU Schengen zone - no customs for EU vessels. Non-EU report to Capitainerie.",
    },
    localKnowledge: {
      bestApproach:
        "Goulet tidal streams are DANGEROUS at peak flow. Plan passage for slack water.",
      weatherConsiderations: [
        "Atlantic gales frequent Oct-Mar",
        "Brittany fog",
        "Excellent inside rade",
      ],
      tidalConsiderations:
        "One of the largest tidal ranges in Europe (7m+). Goulet currents 5+ knots.",
      notes: [
        "Oceanopolis aquarium",
        "Major French naval port",
        "Gateway to Brittany cruising",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    facilities: {
      ...
      repair: {
        available: true,
        types: ["engine", "rigging", "fiberglass", "electronics"],
      },
      haulOut: true,
      chandlery: true,
    },
    navigation: {
      ...
      hazards: [
        ...
        "Shallow approaches at low tide",
        "Mussel farms nearby",
      ],
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: false,
      procedures: "EU Schengen zone",
    },
    localKnowledge: {
      bestApproach:
        "Largest marina on the Atlantic coast (4,500 berths). Excellent stop for Biscay crossing.",
      weatherConsiderations: [
        "Bay of Biscay weather systems",
        "Protected from SW",
        "Summer sea breeze reliable",
      ],
      tidalConsiderations:
        "Large tidal range means significant depth changes - check berth depths",
      notes: [
        "4,500 berths - largest Atlantic marina",
        "Beautiful medieval old town",
        "Grand Pavois boat show (Sep)",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    navigation: {
      ...
      tidalRange: 10.0,
      approach:
        "From the west, round Cabo da Roca and head east to Cascais bay",
      hazards: [
        "Cabo da Roca - strong winds/seas",
        "Swell can wrap into bay",
        "River Tagus current near Lisbon",
      ],
    },
    services: {
      slips: {
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: false,
      procedures: "EU Schengen zone. Non-EU vessels clear at marina office.",
    },
    localKnowledge: {
      bestApproach:
        "Popular staging point for ARC and transatlantic passages. Close to Lisbon.",
      weatherConsiderations: [
        "Portuguese trade winds (Nortada) strong Jul-Sep",
        "Cabo da Roca exposed to NW swell",
        "Mild winters",
      ],
      notes: [
...

  {
    ...
    navigation: {
      ...
      tidalRange: 3.0,
      approach:
        "Enter from the west past the runway, or from the east via the Bay",
      hazards: [
        "Strait of Gibraltar current (2-3 knots east)",
        "Heavy shipping traffic",
        "Low-flying aircraft near runway",
      ],
    ...
    customs: {
      ...
      cbpRequired: false,
      procedures:
        "British Overseas Territory. Clear customs on arrival. Duty-free fuel available.",
    },
    localKnowledge: {
      bestApproach:
        "Gateway between Atlantic and Mediterranean. Duty-free fuel (cheapest in region). Time Strait crossing for current.",
      weatherConsiderations: [
        "Levanter (E wind) brings cloud/rain",
        "Poniente (W wind) is clear",
        "Strait funnels wind dramatically",
      ],
      tidalConsiderations:
        "Strait current typically 1-3 knots eastward. Counter-current close inshore.",
      notes: [
        "Duty-free fuel and provisions",
        "Strait of Gibraltar crossing point",
        "Tax-free shopping",
        "Excellent yacht services",
      ],
    },
...

  {
    ...
    navigation: {
      ...
      hazards: [
        "Heavy commercial port traffic to the south",
        "Cruise ships",
        "Strong onshore breeze afternoons",
      ],
    },
    services: {
      slips: {
    ...
    localKnowledge: {
      bestApproach:
        "Purpose-built for 1992 Olympics. Central Barcelona location with metro access.",
      weatherConsiderations: [
        "Tramuntana (N wind) can be very strong",
        "Sea breeze afternoon",
        "Mild winters",
      ],
      notes: [
        "Walking distance to Las Ramblas",
        "Excellent restaurants",
        "Gateway to Balearics",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    type: "yacht_club",
    coordinates: { latitude: 39.563, longitude: 2.6349 },
    location: {
    ...
    facilities: {
      ...
      repair: {
        available: true,
        types: ["engine", "rigging", "fiberglass", "sails", "electronics"],
      },
      haulOut: true,
      chandlery: true,
    },
    ...
    localKnowledge: {
      bestApproach:
        "Mediterranean sailing capital. World-class yacht services and infrastructure.",
      weatherConsiderations: [
        "Summer sea breeze (embat) reliable 12-20kt",
        "Tramuntana (N) can be severe in winter",
        "Beautiful sailing conditions Apr-Oct",
      ],
      notes: [
        "Superyacht hub",
        "STP shipyard world-class",
        "Kings Cup regatta",
        "Beautiful old town",
      ],
    },
...

  {
    ...
    type: "harbor",
    coordinates: { latitude: 43.295, longitude: 5.3698 },
    ...
    navigation: {
      ...
      hazards: [
        "Mistral wind can blow 40+ knots",
        "Ferry traffic",
        "Shallow areas in old port",
      ],
    },
    services: {
      slips: {
    ...
    localKnowledge: {
      bestApproach:
        "Iconic harbour entrance. Mistral can strike with little warning - have engine ready.",
      weatherConsiderations: [
        "Mistral (NW) severe and sudden - up to 60kt",
        "Calm in summer",
        "Sea state builds rapidly with Mistral",
      ],
      notes: [
        "Historic old port",
...

  {
    ...
    navigation: {
      ...
      tidalRange: 0.5,
      approach:
        "Enter the commercial port area, marina is in the historic inner harbour",
      hazards: [
        "Large vessel traffic",
        "Ferry and cruise ship maneuvers",
        "Swell from SE",
      ],
    },
    services: {
    ...
    localKnowledge: {
      bestApproach:
        "Heart of Genoa. Aquarium and historic centre adjacent. Good base for Italian Riviera.",
      weatherConsiderations: [
        "Libeccio (SW) can be strong",
        "Winter gales occasional",
        "Well protected inside harbour",
      ],
      notes: [
        "Genoa Boat Show (Sep)",
        "UNESCO World Heritage old town",
        "Gateway to Italian Riviera & Cinque Terre",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    type: "marina",
    coordinates: { latitude: 35.8911, longitude: 14.514 },
    ...
    navigation: {
      ...
      tidalRange: 0.5,
      approach:
        "Enter Grand Harbour past the breakwater - dramatic entrance below fortifications",
      hazards: [
        "Strong Gregale (NE) wind can make entrance rough",
        "Commercial traffic",
      ],
    },
    services: {
      slips: {
        ...
        transient: true,
        maxLength: 200,
        reservation: "Recommended Oct-Jun",
      },
      moorings: { available: false, rental: false },
      anchorage: {
        available: true,
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: false,
      procedures: "EU Schengen zone. English widely spoken.",
    },
    localKnowledge: {
      bestApproach:
        "One of the most spectacular harbour entrances in the world. Below the Knights of Malta fortifications.",
      weatherConsiderations: [
        "Gregale (NE) can blow hard",
        "Sirocco (SE) brings heat and sand",
        "Mild year-round",
      ],
      notes: [
        "UNESCO World Heritage Site",
        "Excellent mid-Med stop",
        "Rolex Middle Sea Race (Oct)",
        "English-speaking",
      ],
    },
    amenities: {
...

  {
    ...
    navigation: {
      ...
      hazards: [
        "Bura (NE) katabatic wind can be sudden and violent",
        "Ferry traffic",
        "Tourist boats in summer",
      ],
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: false,
      procedures: "EU Schengen zone (Croatia joined 2023)",
    },
    localKnowledge: {
      bestApproach:
        "Main charter base for Dalmatian islands. Diocletian Palace UNESCO site in town.",
      weatherConsiderations: [
        "Bura (NE) violent katabatic - can strike suddenly at 50+ knots",
        "Jugo (SE) brings rain",
        "Maestral (NW) sea breeze reliable summer",
      ],
      tidalConsiderations:
        "Minimal tidal range but seiches can cause 50cm changes",
      notes: [
        "Charter capital of Adriatic",
        "1000+ islands to explore",
...

  {
    ...
    services: {
      slips: {
        ...
        transient: true,
        maxLength: 70,
        reservation: "Essential in season",
      },
      moorings: { available: false, rental: false },
      anchorage: {
        available: true,
    ...
    customs: {
      ...
      cbpRequired: false,
      procedures:
        "EU Schengen zone. Montenegro border nearby - check if crossing.",
    },
    localKnowledge: {
      bestApproach:
        "Sheltered inlet provides good protection. Bus to Old Town. Book well ahead.",
      weatherConsiderations: [
        "Bura can be strong",
        "Well protected in inlet",
        "Hot summers",
      ],
      notes: [
        "UNESCO Old Town",
        "Game of Thrones filming location",
        "Near Montenegro border",
...

  {
    ...
    navigation: {
      ...
      hazards: [
        "Meltemi wind (N) can be very strong Jul-Aug",
        "Shallow patches near entrance",
      ],
    },
    services: {
      slips: {
    ...
    customs: {
      ...
      cbpRequired: false,
      procedures:
        "EU Schengen zone. DEKPA (transit log) required for non-EU flagged vessels.",
    },
    localKnowledge: {
      bestApproach:
        "Largest marina in Greece. Gateway to Saronic Gulf and Cyclades islands.",
      weatherConsiderations: [
        "Meltemi (N) dominates Jul-Aug, 25-40kt",
        "Calm in Saronic Gulf compared to Cyclades",
        "Hot dry summers",
      ],
      notes: [
        "Metro to central Athens",
        "Major charter base",
        "Gateway to Greek islands",
        "Affordable by Med standards",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    name: "Lefkas Marina",
    type: "marina",
    coordinates: { latitude: 38.8326, longitude: 20.707 },
    ...
    navigation: {
      ...
      tidalRange: 0.5,
      approach:
        "Through the Lefkada Canal from the north - swing bridge opens on the hour",
      hazards: [
        "Canal is narrow and shallow (2m depth)",
        "Swing bridge schedule",
        "Sand bar at canal entrance",
      ],
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: false,
      procedures: "EU Schengen zone. Port police for check-in.",
    },
    localKnowledge: {
      bestApproach:
        "Canal bridge opens at set times - check schedule. Major charter base for Ionian islands.",
      weatherConsiderations: [
        "Ionian is calmer than Aegean - no Meltemi",
        "Afternoon thermal breeze",
        "Green and lush (more rain than Aegean)",
      ],
      notes: [
        "Major Ionian charter base",
        "Protected from Meltemi",
        "Beautiful beaches",
        "Bridge schedule critical",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    navigation: {
      ...
      hazards: [
        "Meltemi creates rough seas in approach",
        "Surge in harbour with NW winds",
        "Shallow near walls",
      ],
    },
    services: {
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: false,
      procedures: "EU Schengen zone. Useful stop before/after Turkey.",
    },
    localKnowledge: {
      bestApproach:
        "Historic harbour where the Colossus once stood. Med-moor stern-to on the quay.",
      weatherConsiderations: [
        "Meltemi can blow 30+ knots Jul-Aug",
        "Sheltered from south",
        "Hot dry summers",
      ],
      notes: [
        "UNESCO Medieval Old Town",
        "Close to Turkish coast",
        "Last Greek stop before Turkey",
        "Historic Knights quarter",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    navigation: {
      ...
      tidalRange: 0.5,
      approach:
        "Enter the large natural bay from the southwest, marina at the head",
      hazards: [
        "Gulet and day-tripper traffic in summer",
        "Shallow area near town quay",
      ],
    },
    services: {
      slips: {
        ...
        transient: true,
        maxLength: 150,
        reservation: "Recommended May-Oct",
      },
      moorings: { available: false, rental: false },
      anchorage: {
        available: true,
    ...
    customs: {
      ...
      cbpRequired: false,
      procedures:
        "Turkish transit log required. Check in with Harbour Master, customs, and immigration.",
    },
    localKnowledge: {
      bestApproach:
        "One of the best protected natural harbours in the Med. Popular wintering spot.",
      weatherConsiderations: [
        "Excellent protection from all directions",
        "Hot summers",
        "Mild winters - popular overwinter spot",
      ],
      notes: [
        "Major charter base",
        "Excellent value for repairs",
        "Beautiful Turkish coast",
        "Popular overwinter destination",
      ],
    },
    amenities: {
      restaurants: true,
...

  {
    ...
    navigation: {
      ...
      tidalRange: 0.5,
      approach:
        "Enter Bodrum Bay from the west, marina below the Castle of St. Peter",
      hazards: [
        "Meltemi creates steep seas in approach",
    ...
    customs: {
      portOfEntry: true,
      cbpRequired: false,
      procedures: "Turkish transit log required.",
    },
    localKnowledge: {
      bestApproach:
        "Beautiful approach below the Crusader castle. Home of blue voyage (gulet) tradition.",
      weatherConsiderations: [
        "Meltemi can blow hard Jul-Aug",
        "Protected from S and W",
        "Excellent spring/autumn sailing",
      ],
      notes: [
        "Castle of St. Peter (museum)",
        "Bodrum Cup regatta",
        "Home of gulet tradition",
        "Vibrant nightlife",
      ],
    },
    amenities: {
  ...
  // =============================================
  // GLOBAL COVERAGE (Caribbean, UK/Ireland, Northern Europe,
  // Australia/NZ, Pacific Islands, SE Asia, South Africa, Canada)
  // sourced from globalPorts.ts.
  // =============================================
  ...GLOBAL_PORTS,
];
...
export function findPortsForDraft(
  ...
  Port & { distance: number; suitable: boolean; clearanceMargin: number }
> {
