...
export function DemoPassage() {
  ...
  const demoRoute = {
    ...
    waypoints: [
      ...
      { name: "Gloucester", lat: 42.6159, lng: -70.662 },
        ...
        {!isPlaying ? (
          <div className="text-center py-8">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">
                ...
                including weather routing, tide calculations, and safety
                considerations.
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span>
                    {demoRoute.departure} → {demoRoute.destination}
                  </span>
                </div>
                <div className="flex items-center gap-2 text-sm">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span>
                    {demoRoute.weather.wind.direction}{" "}
                    {demoRoute.weather.wind.speed} kts
                  </span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span>
                    {demoRoute.weather.waves.height}m @{" "}
                    {demoRoute.weather.waves.period}s
                  </span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          ...
                          {Math.abs(waypoint.lng).toFixed(4)}°W
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium">
                        {demoRoute.weather.wind.direction}{" "}
                        {demoRoute.weather.wind.speed}-
                        {demoRoute.weather.wind.gusts} kts
                      </p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Sea State</p>
                      <p className="font-medium">
                        {demoRoute.weather.waves.height}m waves,{" "}
                        {demoRoute.weather.waves.period}s period
                      </p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Visibility</p>
                      <p className="font-medium">
                        {demoRoute.weather.visibility} nm
                      </p>
                    </div>
                    <div>
            ...
            <div className="flex gap-3 pt-4 border-t">
              ...
              <Button className="flex-1">Plan Your Own Passage</Button>
            </div>
          </div>
        )}
      </CardContent>
