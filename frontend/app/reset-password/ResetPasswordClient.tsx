...
export default function ResetPasswordClient() {
  ...
  return (
    <div className="min-h-screen flex">
      <AuthBrandColumn
        headline={{ line1: "Recover Your", line2: "Account" }}
        description="A reset link will be sent to your email. Most links arrive within a minute."
        features={[
          "Reset links expire after 1 hour",
          "Secure email delivery via Resend",
          "Account data never leaves your control",
        ]}
      />
