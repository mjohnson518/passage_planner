...
import { Anchor, History, ArrowRight } from 'lucide-react'
    ...
    <>
      ...
      <div className="min-h-screen px-4 py-16 sm:px-6 lg:px-8 flex items-center">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="font-display text-4xl mb-4">Changelog Coming Soon</h1>
          <p className="text-lg text-muted-foreground mb-8">
            We&apos;re setting up a changelog to keep you informed about new features, improvements, and fixes as Helmwise evolves.
          </p>
          <p className="text-muted-foreground mb-10">
            In the meantime, check out the features already available on the platform.
          </p>
          <Link href="/features">
