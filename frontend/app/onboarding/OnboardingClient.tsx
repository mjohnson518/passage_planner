      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-card rounded-lg shadow-maritime p-8 border border-border">
            ...
            {currentStep === 1 && (
              <BoatSetupStep data={onboardingData} onUpdate={updateData} />
            )}

            {currentStep === 2 && (
              <PreferencesStep data={onboardingData} onUpdate={updateData} />
            )}

            {currentStep === 3 && <TutorialStep />}

            {currentStep === 4 && <CompletionStep data={onboardingData} />}
          </div>
