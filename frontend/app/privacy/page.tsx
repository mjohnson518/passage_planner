        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-10">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                While your account is active, we retain your account
                information, vessel data, and passage plans to provide the
                Service. Safety audit logs are retained for compliance and
                safety improvement purposes.
              </p>
              <p className="text-muted-foreground mt-4">
                <strong>Upon account closure:</strong> When you request account
                deletion, we will delete your personal data, vessel information,
                and passage plans within 30 days. Anonymized and aggregated data
                that cannot be used to identify you may be retained for
                analytical purposes. Safety audit logs may be retained in
                anonymized form as required for regulatory compliance.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li>
                  ...
                  account and associated personal data. We will process deletion
                  requests within 30 days.
                </li>
                <li>
                  <strong>Export:</strong> You can export your passage plans in
                  GPX and PDF formats at any time. You can also request a
                  complete export of your personal data.
                </li>
                <li>
